...
<div class="press">
  ...
  <div class="content">
    ...
    <div class="list">
      <div class="date">2008年8月11日</div>
      <div class="text">年収・給料・給与を上場企業から計る「転職のモノサシ」をオープンしました<br /><a href="{$smarty.const.ILUNAURL}/press2008//pdf/20080811.pdf">プレス資料</a></div>
      <div class="spacer">&nbsp;</div>
    </div>
